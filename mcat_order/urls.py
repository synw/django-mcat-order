...
from mcat_order.views import add_to_cart, clear_cart, remove_from_cart, CustomerFormView, order_dispatcher, ConfirmOrderView, CustomerUpdateFormView, PostOrderView
...
url(r'^post/$', PostOrderView.as_view(), name="mcat-post-order"),
